...
confs_names = [
    ...
    'cl_top500_banlist_proxy',
    'cl_top500_banlist_direct'
...
values['gfwlist_direct'] = getRulesStringFromFile('resultant/gfw_bypass.list', 'Direct')
values['gfwlist_proxy'] = getRulesStringFromFile('resultant/gfw.list', 'Proxy') \
